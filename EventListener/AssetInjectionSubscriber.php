...
/**
 * Loads campaign-email-dispatch.js globally, the same way GrapesJsBuilderBundle
 * injects its own JS/vars via 'page.header.left' (a context rendered on every
 * admin page, not just the campaign builder). Harmless elsewhere — the file
 * only defines Mautic.n8nDispatch* functions, which nothing calls unless the
 * "Send via n8n (Email)" campaign action form is actually on the page.
 */
